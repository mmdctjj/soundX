...
export const getRecommendedAlbums = (type?: string, random: boolean = false, pageSize: number = 8) => {
...
export const getRecentAlbums = (type?: string, random: boolean = false, pageSize: number = 8) => {
